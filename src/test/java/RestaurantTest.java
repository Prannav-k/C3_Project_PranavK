...
class RestaurantTest {
    ...
    //method to replace repeated code
    @BeforeEach
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime openedTimeMock = LocalTime.parse("20:00:00");
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(openedTimeMock);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant spiedRestaurant = Mockito.spy(restaurant);
        LocalTime closedTimeMock = LocalTime.parse("23:00:00");
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(closedTimeMock);
        Boolean isOpen=spiedRestaurant.isRestaurantOpen();
        assertFalse(isOpen);
    }
